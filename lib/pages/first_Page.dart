          ...
          child: Row(
            children: [
              ...
              const Padding(
                ...
                child: Text('Solutions', style: TextStyle(color: Colors.black, fontSize: 15)),
              ),
              const Padding(
                padding: EdgeInsets.only(top: 10),
                child: Icon(
              ...
              const Padding(
                padding: EdgeInsets.only(top: 10),
                child: Text('Pricing', style: TextStyle(color: Colors.black, fontSize: 15)),
              ),
              const SizedBox(
                width: 20,
              ),
              const Padding(
                padding: EdgeInsets.only(top: 10),
                child: Text('Resources', style: TextStyle(color: Colors.black, fontSize: 15)),
              ),
              const Padding(
                padding: EdgeInsets.only(top: 10),
                child: Icon(
              ...
              Padding(
                ...
                child: InkWell(
                    ...
                    child: const Text('Log in', style: TextStyle(color: Colors.black, fontSize: 15))),
              ),
              const SizedBox(
                width: 25,
              ),
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    width: 450,
                    decoration:
                        const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(40)), color: Colors.black),
                    child: Column(
                      children: [
                        Padding(
